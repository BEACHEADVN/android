...
echo "      Little: `cat /sys/module/cpu_input_boost/parameters/input_boost_freq_lp | sed 's+ 1:.*++g; s+0:++g'` MHz"
echo "      Big: `cat /sys/module/cpu_input_boost/parameters/input_boost_freq_hp | sed 's+ 2:.*++g; s+^.*1:++g'` MHz"
