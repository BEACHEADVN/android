...
if su -c "find /data/app -type d -name 'com.mservice.momotransfer*'" | grep -q .
then
	echo "•Momo đã được cài đặt."
	name="Momo"
	package="com.mservice.momotransfer"
	activity="vn.momo.platform.entry.MainActivity"
else
	echo "•Momo chưa được cài đặt."
	...
	do
	    ...
	    case $choice in
	        1)
	            ...
	            termux-open https://play.google.com/store/apps/details?id=com.mservice.momotransfer
	            break
	            ;;
	        2)
