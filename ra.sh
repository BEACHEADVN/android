...
if [ $a = on ]
then
	for i in hoyolab hackdata shopee adaway vcb momo lazada quickedit mtm tiktok xiaomiearbuds myviettel mtmanager twitter vneid instagram
	do
...
if [ $a = 13 ]
then
	source /storage/emulated/0/Download/ext/temp/xiaomiearbuds.sh
	if [ $b = 1 ]
	then
		enable
		run
