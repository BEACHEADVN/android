...
if su -c "find /data/app -type d -name 'com.twitter.android*'" | grep -q .
then
	echo "•X đã được cài đặt."
	name="X"
	package="com.twitter.android"
	activity="com.twitter.android.StartActivity"
else
	echo "•X chưa được cài đặt."
	...
	do
	    ...
	    case $choice in
	        1)
	            ...
	            termux-open https://play.google.com/store/apps/details?id=com.twitter.android
	            break
	            ;;
	        2)
